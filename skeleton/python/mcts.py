...
class MCTS:
    __slots__ = ['time_limit', 'first_player', 'root', 'board']

    def __init__(self, ngames, first_player):
        random.seed(42)
        self.time_limit = ngames
    ...
    def expand(self, node):
        ...
        for i in xrange(0,sz):
            ...
            node.lst_childs[i].append(Node(node, not node.next_player, dup))
    ...
    def simulate(self, board, player, depth, child):
        ...
        return simulate(board, not player, depth-1, child)
